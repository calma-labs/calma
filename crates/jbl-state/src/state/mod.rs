...
mod size_tests {
    ...
    #[test]
    fn pool_size() {
        // 4 Pubkeys (128) + total_collateral_deposited (8) + Market (56) +
        // UtilizationFeeConfig (96) + ltv_percent + lp_mint_bump (2) + _pad (6) + WithdrawalQueue
        // Full value checked against POOL_SPACE constant in test utils (41 264).
        assert_eq!(size_of::<Pool>(), 41_264);
    }
